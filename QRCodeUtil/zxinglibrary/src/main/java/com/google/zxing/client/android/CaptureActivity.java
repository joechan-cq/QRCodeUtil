...
import com.google.zxing.client.android.decoding.IntentSource;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public static final int DECODERESULT = 0xff;
    public static final String RESULTKEY = "QRCODE";
    ...
    public void handleDecode(final Result rawResult, Bitmap barcode, float scaleFactor) {
        final ProgressDialog wait = ProgressDialog.show(this, "请稍后", "正在解析");
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                resultIntent.putExtra(RESULTKEY, rawResult.getText());
                setResult(DECODERESULT, resultIntent);
                finish();
            }
        }, 300);
    }
